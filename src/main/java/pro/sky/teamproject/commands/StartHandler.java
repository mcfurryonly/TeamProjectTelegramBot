        ...
        if (update.message() != null) {
            ...
            if (callbackData.equals(DOG)) {
                ...
                InlineKeyboardButton volunteerButton = new InlineKeyboardButton
                        ("Позвать волонтера").callbackData(VOLUNTEER);
                ...
                InlineKeyboardButton volunteerButton1 = new InlineKeyboardButton("Позвать волонтера")
...
//                checkAndAddUser(update);
            ...
            if (callbackData.equals(INFODOG) || callbackData.equals(INFOCAT)) {
                showInfo(update);
...
//                        "или просто проконсультировать какая порода вам больше подойдет "));
            ...
            } else if (callbackData.equals("about")) {
                ...
                return;
            } else if (callbackData.equals("security")) {
...
//    }
    ...
    public void showInfo(Update update) { //Идея такова что при первом нажатии это меню всплывет, а при втором нажатии на старт будет другое меню уже
